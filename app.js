/**
 * Introduction: In this commit I'm going to bulid the data models for flight seat reservation,
 *      [1] Flight Chart (row-major) model, and [2] Passengers Queue (FIFO) model
 * Tech: Node.js (back-end)
